...
class UtilTest {
    ...
    @Test
    @DisplayName("convertToken(token) - Valid token")
    ...
    @Test
    @DisplayName("convertToken(token) - Invalid Format")
    void convertTokenInvalidFormat() {
        String token = "test";
        assertThrows(InvalidTokenFormat.class, () -> Util.convertToken(token));
    }

    @Test
    @DisplayName("convertToken(token) - Invalid Value")
    ...
    @Test
    @DisplayName("convertToken(token) - Not Verified Email")
    void convertTokenNotVerifiedEmail() {
        ...
        assertThrows(EmailNotVerified.class, () -> Util.convertToken(token));
    }
}